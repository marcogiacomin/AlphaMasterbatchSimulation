...
C31 = Cono(rfid='C31', df_coni=stato.df_coni)
C32 = Cono(rfid='C32', df_coni=stato.df_coni)
C33 = Cono(rfid='C33', df_coni=stato.df_coni)
C34 = Cono(rfid='C34', df_coni=stato.df_coni)
C35 = Cono(rfid='C35', df_coni=stato.df_coni)
C36 = Cono(rfid='C36', df_coni=stato.df_coni)
